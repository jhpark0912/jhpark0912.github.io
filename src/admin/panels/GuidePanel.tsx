    ...
    <div className={styles.editor}>
      ...
      >
        <List>
          ...
          <Item term="사진 위치">
            비율을 못 맞춘 사진은 <strong>가로 · 세로 막대</strong>로 어느 쪽을 남길지 정할 수 있습니다. 옆의
            미리보기가 실제로 잘린 모습이니 그것을 보면서 맞추시면 됩니다. 두 막대 중 실제로 움직이는 것은
            <strong> 사진이 잘리는 방향 하나뿐</strong>이고, 나머지 하나는 아무것도 하지 않습니다.
          </Item>
          <Item term="사진 크기">
            사이사이 사진 세 자리에는 <strong>크기 막대</strong>가 하나 더 있습니다. 100%가 사진을 그대로 넣은
            상태이고, 올리면 <strong>가로 · 세로로 맞춰 둔 지점을 중심으로 확대</strong>됩니다. 멀리서 찍혀 얼굴이
            작게 들어갈 때 쓰시면 됩니다.
            <br />
            <strong>줄이는 쪽은 없습니다.</strong> 100%에서 이미 사진이 틀을 꽉 채우고 있어서, 그보다 줄이면 사진이
            더 보이는 게 아니라 틀 가장자리에 빈 여백이 생깁니다. 위아래가 너무 잘린다면 크기가 아니라{' '}
            <strong>세로 막대</strong>로 남길 쪽을 정하시는 것이 맞습니다.
          </Item>

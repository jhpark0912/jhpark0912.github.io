      ...
      >
        <List>
          ...
          <Item term="신랑신부 사진 · 가로 16:9">
            ...
            자리입니다. 사이사이 사진 중 유일한 가로 자리이니{' '}
            <strong>세로 사진을 넣으면 위아래가 크게 잘려</strong> 얼굴이 날아갈 수 있습니다. <strong>가로로 찍은 상반신 사진</strong>이 가장 잘 맞습니다 — 전신 사진은 띠가 낮아
            얼굴이 작게 들어갑니다.
          </Item>
          <Item term="일정 사진 · 오시는 길 사진 · 인사 사진 · 세로 4:5">
            <strong>1120×1400 픽셀.</strong> 셋 다 글 사이에 한 장씩 놓이는 세로 자리입니다.
          </Item>
